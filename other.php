...
<html lang="en">
  ...
  <body>
    ...
    <form action="successful upload.php">
      <h1>Please enter the details of the item you want to sell here</h1>
      <br /><br /><br />
      <label for="name">Name of product:</label><br />
      <input type="text" name="name" id="name" /><br /><br />
      <label for="description">Brief product description:</label><br />
      ...
      <br />
      <input type="file"name="product_image"id="product_image"accept="image/*"required><br /><br />
      <input type="file"name="product_image"id="product_image"accept="image/*"required ><br /><br />
